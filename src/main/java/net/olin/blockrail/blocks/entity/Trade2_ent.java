...
public class Trade2_ent extends BlockEntity implements SidedInventory, ExtendedScreenHandlerFactory, ImplementedInventory {
	...
	private Item inputItem = AllBlocks.TRACK.asItem();
	private int inputAmount = 64; //Hur mycket input

	private Item outputItem = ModItems.TICKET;
	private int outputAmount = 1; //hur mycket output
	//

	public Trade2_ent(BlockPos pos, BlockState state) {
		super(ModBlockEntities.TRADE2, pos, state);
		this.counterMax = inputAmount;
		this.propertyDelegate = new PropertyDelegate() {
			@Override
			public int get(int index) {
				return switch (index) {
					case 0 -> Trade2_ent.this.counterCurrent;
					case 1 -> Trade2_ent.this.counterMax;
			...
			public void set(int index, int value) {
				switch (index) {
					case 0:
						Trade2_ent.this.counterCurrent = value;
					case 1:
						Trade2_ent.this.counterMax = value;
				}
			}
	...
	public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
		return new Trade2_screen_handler(syncId, playerInventory, this, this.propertyDelegate);
	}
