...
public class Trade1_ent extends BlockEntity implements SidedInventory, ExtendedScreenHandlerFactory, ImplementedInventory {
	...
	//Trade data
	private final int block_id = 1;

	private Item inputItem = Items.IRON_INGOT;
	private int inputAmount = 320; //Hur mycket input

	private Item outputItem = ModItems.TICKET;
	private int outputAmount = 1; //hur mycket output
	//

	public Trade1_ent(BlockPos pos, BlockState state) {
		super(ModBlockEntities.TRADE1, pos, state);
		this.counterMax = inputAmount;
		this.propertyDelegate = new PropertyDelegate() {
			@Override
			public int get(int index) {
				return switch (index) {
					case 0 -> Trade1_ent.this.counterCurrent;
					case 1 -> Trade1_ent.this.counterMax;
			...
			public void set(int index, int value) {
				switch (index) {
					case 0:
						Trade1_ent.this.counterCurrent = value;
					case 1:
						Trade1_ent.this.counterMax = value;
				}
			}
	...
	public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
		return new Trade1_screen_handler(syncId, playerInventory, this, this.propertyDelegate);
	}
