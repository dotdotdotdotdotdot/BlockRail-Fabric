...
public class CustomSlot implements SlotExtensions {
    private final int index;
    public final CustomInventory inventory;
    public int id;
    public final int x;
    public final int y;

    public CustomSlot(CustomInventory inventory, int index, int x, int y) {
