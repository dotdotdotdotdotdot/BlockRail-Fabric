...
public class Trade3_screen extends HandledScreen<Trade3_screen_handler> {
	private static final Identifier TEXTURE = new Identifier(BlockRail.MOD_ID, "textures/gui/export_block_gui.png");
	public Trade3_screen(Trade3_screen_handler handler, PlayerInventory inventory, Text title) {
