...
public class Trade2_screen extends HandledScreen<Trade2_screen_handler> {
	private static final Identifier TEXTURE = new Identifier(BlockRail.MOD_ID, "textures/gui/export_block_gui.png");
	public Trade2_screen(Trade2_screen_handler handler, PlayerInventory inventory, Text title) {
