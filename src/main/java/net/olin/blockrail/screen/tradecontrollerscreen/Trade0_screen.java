...
public class Trade0_screen extends HandledScreen<Trade0_screen_handler> {
	private static final Identifier TEXTURE = new Identifier(BlockRail.MOD_ID, "textures/gui/export_block_gui.png");
	public Trade0_screen(Trade0_screen_handler handler, PlayerInventory inventory, Text title) {
